...
namespace ToggleMesh.API.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260622200450_EnterpriseMetricsRefactoring")]
    partial class EnterpriseMetricsRefactoring
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Analytics.Entities.AnalyticsExposure", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Analytics.Entities.AnalyticsTrack", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Analytics.Entities.ContextualExperimentMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Analytics.Entities.ExperimentIteration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Analytics.Entities.ExperimentMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Flags.FlagEnvironmentState", b =>
                {
                    ...
                    b.Property<Dictionary<string, int>>("ContextualRollouts")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Metrics.Entities.FlagMetricBucket", b =>
                {
                    ...
                    b.ToTable("FlagMetricBuckets", t =>
                        {
                            t.HasComment("fillfactor=70");
                        });
                });
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Segments.Entities.Segment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Segments.Entities.SegmentRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToggleMesh.API.Features.Segments.Entities.SegmentRule", b =>
                {
                    b.HasOne("ToggleMesh.API.Features.Segments.Entities.Segment", "Segment")
                        .WithMany("Rules")
