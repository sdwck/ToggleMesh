    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectFeatureFlags", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlagEnvironmentStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlagEnvironmentStates_Environments_EnvironmentId",
                        column: x => x.EnvironmentId,
                        principalTable: "Environments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlagEnvironmentStates_ProjectFeatureFlags_FeatureFlagId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectFlagRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectFlagRules_FlagEnvironmentStates_FlagEnvironmentState~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlagEnvironmentStates_EnvironmentId",
                table: "FlagEnvironmentStates",
                column: "EnvironmentId");

            migrationBuilder.CreateIndex(
                name: "IX_FlagEnvironmentStates_FeatureFlagId_EnvironmentId",
                table: "FlagEnvironmentStates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectFlagRules_FlagEnvironmentStateId",
